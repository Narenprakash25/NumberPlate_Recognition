...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('C:/Users/lokes/Downloads/IVA Project/NumberPlateRecognition/yolov5-master', 'custom', source ='local', path='best.pt')
...
#main(vid_path="./test_images/test number plate.mp4",vid_out="vid_1.mp4") ### for custom video
main(vid_path=0,vid_out="numberplate_result5.mp4") # For Webcam

# main(img_path="./test_images/bus.jpg") ## for image